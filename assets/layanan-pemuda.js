// ===================================
// LAYANAN PEMUDA - JAVASCRIPT
// ===================================

console.log('🔥 Layanan Pemuda page loaded');
...
function setActiveMenu() {
    ...
    navLinks.forEach(link => {
        ...
        // Highlight Pemuda link
        if ((href === 'layanan-pemuda.html' || href === 'pemuda.html') &&
            (currentPage === 'layanan-pemuda.html' || currentPage === 'pemuda.html')) {
            link.classList.add('menu-active');
            link.style.backgroundColor = 'rgba(201, 168, 118, 0.3)';
        }
        // Highlight Pelayanan > Pemuda dropdown
        else if (currentPage === 'layanan-pemuda.html' && href === 'pelayanan.html#pemuda') {
...
function setupHeroAnimation() {
    const heroText = document.querySelector('.hero-pemuda');
    if (heroText) {
...
console.log('✅ Layanan Pemuda JS - All functions initialized');
